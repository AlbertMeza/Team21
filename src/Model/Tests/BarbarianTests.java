...
/**
 * This class tests Barbarian class
 *
...
public class BarbarianTests {
    ...
    public static void main(String[] theArgs) {
        AbstractCharacter myCharacter = new Barbarian();
    ...
    private static String verifyName(AbstractCharacter theCharacter) {
        if ("Barbarian".equals(theCharacter.getName())) {
    ...
    private static String verifyDodgeRate(AbstractCharacter theCharacter) {
        if (0.3 == theCharacter.getDodgeRate()) {
